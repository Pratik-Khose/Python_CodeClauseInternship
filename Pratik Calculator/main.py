...
me.title("Pratik's Calculator")

melabel = Label(me, text="Pratik's Calculator", bg='White', font=("Comic Sans MS", 25, 'bold'))
...
metext = Entry(me, font=("Courier New", 12, 'bold'), textvar=textin, width=35, bd=8, bg='powder blue')
metext.pack()
...
butclear = Button(me, padx=14, pady=49, bd=4, bg='white', text="CE", command=clrbut, font=("Courier New", 16, 'bold'))
butclear.place(x=270, y=100)

butequal = Button(me, padx=20, pady=49, bd=4, bg='white', command=equlbut, text="=", font=("Courier New", 16, 'bold'))
